const styles = {
    ...
    button_white: "w-[80%] inline-flex items-center justify-center whitespace-nowrap rounded-3xl border-2 border-white py-2 text-base font-medium text-white shadow-sm hover:bg-white hover:text-primary",
